...
Now you have all the functions available to you through MySQLi. You can change the database that you are connection to by passing the name as a parameter.
